...
import gov.nist.healthcare.ttt.direct.messageGenerator.MDNDifferentCaseGenerator;
import java.io.File;
...
public class MDNGeneratorDifferentCaseTest {
	...
	public static void main(String[] args) throws MessagingException, Exception {
		MDNDifferentCaseGenerator generator = new MDNDifferentCaseGenerator();
