...
public class SmtpEdgeLogFacade extends DatabaseFacade {
    ...
    public String saveSmtpProfile(SmtpEdgeProfileInterface profile) throws DatabaseException {
        ...
        byte[] encodedBytes = Base64.encodeBase64(profile.getSutPassword().getBytes());
        StringBuilder sql = new StringBuilder();
        ...
        sql.append(SMTPEDGEPROFILE_SUTPASSWORD + " = '" + (new String(encodedBytes)) + "' ,");
    ...
    private String addNewSmtpProfile(SmtpEdgeProfileInterface profile) throws DatabaseException {
        ...
        sql.append("' , '");
        sql.append(DatabaseConnection.makeSafe(new String(encodedBytes)));
        sql.append("' , ");
    ...
    private SmtpEdgeProfileInterface convertToProfile(ResultSet result) throws DatabaseException {
        ...
        try {
        	byte[] decodedBytes = Base64.decodeBase64(result.getString(SMTPEDGEPROFILE_SUTPASSWORD));
            ...
            profile.setSutPassword(new String(decodedBytes));
