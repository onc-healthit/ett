...
<xsl:stylesheet version="1.0"
    ...
    <xsl:output1 method="html" indent="yes" version="4.01" encoding="ISO-8859-1" doctype-system="http://www.w3.org/TR/html4/strict.dtd" doctype-public="-//W3C//DTD HTML 4.01//EN"/>
    
    <xsl:param1 name="limit-external-images" select="'yes'"/>
    <!-- A vertical bar separated list of URI prefixes, such as "http://www.example.com|https://www.example.com" -->
    <xsl:param1 name="external-image-whitelist"/>
    <!-- string processing variables -->
    <xsl:variable1 name="lc" select="'abcdefghijklmnopqrstuvwxyz'" />
    <xsl:variable1 name="uc" select="'ABCDEFGHIJKLMNOPQRSTUVWXYZ'" />
    <!-- removes the following characters, in addition to line breaks "':;?`{}“”„‚’ -->
    <xsl:variable1 name="simple-sanitizer-match"><xsl:text>&#10;&#13;&#34;&#39;&#58;&#59;&#63;&#96;&#123;&#125;&#8220;&#8221;&#8222;&#8218;&#8217;</xsl:text></xsl:variable1>
    <xsl:variable1 name="simple-sanitizer-replace" select="'***************'"/>
    <xsl:variable1 name="javascript-injection-warning">WARNING: Javascript injection attempt detected in source CDA document. Terminating</xsl:variable1>
    <xsl:variable1 name="malicious-content-warning">WARNING: Potentially malicious content found in CDA document.</xsl:variable1>
