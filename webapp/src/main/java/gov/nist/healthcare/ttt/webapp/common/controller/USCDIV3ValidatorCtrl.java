	...
	public @ResponseBody String validateSVAP(@RequestBody HashMap<String, String> filePath) throws Exception {
		if(filePath.containsKey("messageFilePath")) {
			...
			if(messageFilePath != null && !messageFilePath.equals("")) {
				...
				logger.info("Validating SVAP 2023" + filePath.get("messageFilePath") + " with validation objective " + validationObjective + " and reference filename " + referenceFileName);
				System.out.println("Validating SVAP 2023" + filePath.get("messageFilePath") + " with validation objective " + validationObjective + " and reference filename " + referenceFileName);
			...
			if (StringUtils.isBlank(accessToken)){
				...
				builder.addTextBody("svap2022", "false");
				builder.addTextBody("svap2023", "true");
