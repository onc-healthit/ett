...
public class FindMdnForDirectMessageController {
	
	private static Logger logger = Logger.getLogger(FindMdnForDirectMessageController.class.getName());
	...
	public @ResponseBody LogInterface getMdn(@RequestBody String messageId, HttpServletRequest request) throws IOException, DatabaseException, TTTCustomException {
