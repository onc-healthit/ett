 ...
 */
@Component
final class TestCase35mu2 extends TestCaseSender {


    @Autowired
    TestCase35mu2(TestCaseExecutor executor) {
        super(executor)
    }
    ...
    Result run(Map context, String username) {
      ...
      //  context.directTo = "nomdn8@ttpedgetest.sitenv.org"
		context.directTo = "nomdn8@$executor.hostname"
