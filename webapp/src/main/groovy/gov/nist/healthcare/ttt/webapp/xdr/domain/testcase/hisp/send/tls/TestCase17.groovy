package gov.nist.healthcare.ttt.webapp.xdr.domain.testcase.hisp.send.tls
 ...
 */
@Component
final class TestCase17 extends TestCaseSender {

    @Autowired
    public TestCase17(TestCaseExecutor ex) {
        super(ex)
    }
