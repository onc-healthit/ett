 ...
 */
final class TestCase6 extends TestCaseStrategy {
    ...
    UserMessage run(String tcid, Map context, String username) {
        ...
        return new UserMessage(UserMessage.Status.SUCCESS, msg, new TestCaseEvent(step.xdrSimulator.endpointTLS, XDRRecordInterface.CriteriaMet.PENDING))
    }
