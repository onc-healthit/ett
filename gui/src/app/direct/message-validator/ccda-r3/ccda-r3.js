...
ccdaValidator.controller('CCDAR3ValidatorCtrl', ['$scope', '$state', 'ApiUrl','$filter', 'CCDAR3ValidatorFactory','CCDADocumentService','$location','$anchorScroll',
    function($scope, $state, ApiUrl, $filter,CCDAR3ValidatorFactory,CCDADocumentService,$location,$anchorScroll) {
