...
ccdaValidator.controller('CCDAR3ValidatorCtrl', ['$scope', 'CCDAR3ValidatorFactory', '$state', 'ApiUrl', 'CCDADocumentService','$filter', '$location','$anchorScroll',
    function($scope, CCDAR3ValidatorFactory, $state, ApiUrl, CCDADocumentService, $filter,$location,$anchorScroll) {
